      ...
      <div className="flex-grow p-4 bg-gray-100 min-h-screen">
        <div className="container mx-auto">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full bg-white border border-gray-300 rounded-lg shadow-md mb-6">
              <thead>
                <tr className="bg-[#eb671c] text-white">
                ...
                {students.map((student) => (
                  <tr key={student._id} className="border-b">
                    ...
                    <td className="px-4 py-2 flex space-x-2">
                      <button onClick={() => handleEdit(student, 'students')}>
                        <FaPencilAlt />
                      </button>
              ...
              <tbody>
                {teachers.map((teacher) => (
                  <tr key={teacher._id} className="border-b">
                    ...
                    <td className="px-4 py-2 flex space-x-2">
                      <button onClick={() => handleEdit(teacher, 'teachers')}>
                        <FaPencilAlt />
                      </button>
                      <button onClick={() => handleDelete(teacher._id, 'teachers')}>
                        <MdDelete />
                      </button>
                    </td>
                  </tr>
        ...
        {editData && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="bg-white w-full sm:w-3/4 md:w-1/2 p-6 rounded-lg shadow-lg">
              ...
              <div className="flex justify-end space-x-2">
                <button className="px-4 py-2 bg-gray-300 rounded" onClick={closeEditModal}>
                  Cancel
                </button>
                <button className="px-4 py-2 bg-blue-500 text-white rounded" onClick={saveEdit}>
                  Save
                </button>
              </div>
            </div>
